...
public class CalendarUtils {
    ...
    public static String calanderURL = "content://com.android.calendar/calendars";      //日历用户url
    public static String calanderEventURL = "content://com.android.calendar/events";    //事件url
    public static String calanderRemiderURL = "content://com.android.calendar/reminders";   //事件提醒url
