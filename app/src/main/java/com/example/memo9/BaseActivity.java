...
public abstract class BaseActivity extends AppCompatActivity implements WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener {
    ...
    private static final int TYPE_THREE_DAY_VIEW = 2;      //三日视图
    private static final int TYPE_WEEK_VIEW = 3;           //周视图
    private int mWeekViewType = TYPE_THREE_DAY_VIEW;      //默认视图类型为三日视图
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.action_add_event:
                startActivity(new Intent(this, PasteActivity.class));
                return true;
